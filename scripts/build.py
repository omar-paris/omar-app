...
def publication_marker() -> str:
    """Stable version marker: tracked output must not derive from Git metadata."""
    return PUBLISHED
...
<footer class="footer">Omar App · {DOMAIN} · {VERSION} · publication {publication_marker()} · Changelog disponible · Aucun secret client dans cette V0.</footer>
{script}
</body>
</html>"""
...
<footer class="footer">Omar App · {DOMAIN} · {VERSION} · publication {publication_marker()} · Plan d'actions JAB · données dans data/plan-jab.yaml.</footer>
</body>
</html>"""
